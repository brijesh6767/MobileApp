...
const BikePicture: React.FC<ITakePicture> = ({route}:any) => {
  const { PhelboImg } = route.params; 
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.button} onPress={handleToggleCamera}>
        <Text style={styles.buttonText}>Click Here to Upload Bike Picture</Text>
      </TouchableOpacity>
     ...
     onPress={()=> {imgData === '' ? Alert.alert('Mandatory!!','Please click Photo to Procced further') :navigation.navigate(ROUTE_NAME.BAG_PHOTO ,{imgPath:PhelboImg , bikePic:imgData})}}
      />}
    </View>
  );
};
